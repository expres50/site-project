...
<head>
    ...
    <title>Documents - <?php echo htmlspecialchars($str); ?></title>
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    ...
                    <a href="matiere.php" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Matières</a>
                    <a href="exercices.php" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Exercices</a>
...
<!-- Titre catégorie -->
<div class="max-w-4xl mx-auto px-4 mt-10 mb-6">
    <div class="bg-white rounded-xl shadow-sm p-6 text-center">
        <h1 class="text-2xl font-bold text-gray-900">Documents de <span class="text-blue-600"><?php echo htmlspecialchars($str); ?></span></h1>
    </div>
</div>
...
<div class="max-w-4xl mx-auto px-4 mb-8">
    <form action="search.php" method="POST">
        <div class="relative">
            <input type="text" name="search" placeholder="Tapez d'autres recherches ici..." class="w-full border border-gray-300 rounded-full py-3 px-6 pl-12 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg shadow-sm">
...
<div class="max-w-4xl mx-auto px-4">
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        if (!empty($_GET["categorie"])) {
            $str = $_GET["categorie"];
            $sth = $conn->prepare("SELECT * FROM `documents` WHERE matiere = :cat ORDER BY id DESC ");
            $sth->bindParam(':cat', $str, PDO::PARAM_STR);
        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="mt-4 md:mt-0">
                    <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full font-medium shadow transition-all" onclick="openModal()">
                        Voir / Télécharger
                    </button>
                </div>
            </div>
        ...
        if(!$hasDocuments) {
            echo "<div class='text-center text-gray-500 py-8'>Il n'y a plus de résultats !<br>Nous faisons régulièrement des mises à jour, revenez bientôt.</div>";
        }
        ?>
        <div class="text-center mt-6">
            <a href="all-documents.php" class="text-blue-600 hover:underline">Tous les documents</a>
        </div>
    </div>
</div>
...
<div id="myModal" class="fixed z-50 inset-0 overflow-y-auto hidden">
  <div class="flex items-center justify-center min-h-screen px-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-8 relative">
      <button class="absolute top-3 right-3 text-gray-400 hover:text-gray-700 text-2xl font-bold focus:outline-none" onclick="closeModal()" aria-label="Fermer">&times;</button>
...
<footer class="bg-gray-800 mt-12">
    <div class="max-w-7xl mx-auto py-6 px-4 text-center text-gray-400">
        &copy; 2022 EduShare, Tous droits réservés.
    </div>
</footer>
