...
<div class="body-overlay"></div>
			...
			<li >
		      ...
		      <div class="small-screen navbar-display">
               ...
               ?>
                ...
                <li class="dropdown">
                    <a href="users.php" data-toggle="collapse" aria-expanded="false">
		...
		<div class="top-navbar">
                        ...
                        <div style="width: 100%;">
                            <div class="card" style="min-height: 485px; ">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title" style="text-align: center;">Utilisateurs du Forum</h4>
                                    <p class="category" style="text-align: center;">Listes des utilisateurs inscrits sur le Forum</p>
                                </div>
            ...
            $sth = $conn->prepare("SELECT * FROM `users` ORDER BY id desc");
           ...
           <tr>
              ...
              <td class="btn-info" style="text-align: center;"><a href="details-forum-users.php?user_forum_id=<?php echo "$row->id"?>" style="color: white;"><span class="material-icons">visibility</span></a></td>
        </tr>
...
<?php } ?>
                    ...
                    <?php if($cpt==0) {?>
                        <p style="text-align: center; color:red;">Aucune question pour le moment <br></p>
                    <?php } ?>
                                </div>
                            </div>
                        </div>
