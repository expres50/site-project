                        ...
                        <div style="width: 100%;">
                            <div class="card" style="min-height: 485px; ">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category" style="text-align: center;">Listes des utilisateurs inscrits sur le site</p>
                                </div>
	          ...
	          while($row = $sth->fetch())
	         {
		      ...
		      ?>
                                            <tr>
                                                ...
                                                <td><?php echo "$row->name"?>&nbsp;<?php echo "$row->firstname"?></td>
                                                <td><?php echo "$row->niveau"?></td>
                                                <td><?php echo "$row->filiere"?></td>
                                                <td><?php echo "$row->email"?></td>
                                                <td class="btn-info" style="text-align: center;"><a href="details-users.php?id=<?php echo "$row->id" ?>" style="color: white;"><span class="material-icons">visibility</span></a></td>
                                            </tr>
