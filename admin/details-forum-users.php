...
<form action=""  method="post" enctype="multipart/form-data">
    <h2 style="text-align: center;">Détails sur <?php echo "$row->prenom"?> </h2>
   <?php
   ...
   <div class="flex">
      <div class="inputBox" style="width:100%; ">
         <span>Nom :</span>
         <input type="text"  value="<?php echo "$row->nom"?>" class="box" readonly>
         <span>Prénom :</span>
         <input type="text"  value="<?php echo "$row->prenom"?>" class="box" readonly>
         <span>Pseudo :</span>
         <input type="text"  value="<?php echo "$row->pseudo"?>" class="box" readonly>
    
      </div>
      
   </div>
   <br>
   <a href="delete-forum.php?user_forum_id=<?php echo "$row->id"?>" class=" delete-btn">supprimer l'utilisateur </a>
