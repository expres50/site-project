...
<form action=""  method="post" enctype="multipart/form-data">
    <h2 style="text-align: center;">Détails sur <?php echo $fetch['firstname']; ?> </h2>
   <?php
    if($fetch['image'] == ''){
   ...
   <div class="flex">
      <div class="inputBox" style="width:100%; ">
         ...
         <span>Prénom :</span>
         <input type="text"  value="<?php echo $fetch['firstname']; ?>" class="box" readonly>
         <span>Niveau :</span>
         <input type="text"  value="<?php echo $fetch['niveau']; ?>" class="box" readonly>
         <span>Filière :</span>
         <input type="text"  value="<?php echo $fetch['filiere']; ?>" class="box" readonly>
         <span>email :</span>
   ...
   <br>
   <a href="delete.php?user_id=<?php echo $fetch['id']; ?>" class=" delete-btn">supprimer l'utilisateur </a>
