		...
		<div class="top-navbar">
			...
			<div class="main-content">
                        ...
                        <div style="width: 100%;">
                            <div class="card" style="min-height: 485px; ">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title" style="text-align: center;">Documents <?php echo "$niveau" ?></h4>
                                    <p class="category" style="text-align: center;">Listes des documents du site</p>
                                </div>
                    ...
                    if($niveau=='tous'){
                        ...
                        $sth = $conn->prepare("SELECT * FROM `documents` where niveau= '$niveau' ORDER BY id desc");
                    }
                    ...
                    <?php } ?>
                                    ...
                                    <?php if($cpt==0) {?>
                                        <p style="text-align: center; color:red;">Aucun document de <?php echo "$niveau" ?> pour le moment <br> <a href="add-document.php" style="color: blue;">Ajouter</a></p>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
