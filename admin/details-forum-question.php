...
include 'database_forum2.php';

$sth = $conn->prepare("SELECT * FROM `questions` WHERE id='$id'");
...
<form action=""  method="post" enctype="multipart/form-data">
    <h2 style="text-align: center;">Question de <?php echo "$row->pseudo_auteur"?></h2>
   <?php
   ...
   <div class="flex">
      <div class="inputBox" style="width:100%; ">
         <span>Titre :</span>
         <input type="text"  value="<?php echo "$row->titre"?>" class="box" readonly>
         <span>Description :</span>
         <input type="text"  value="<?php echo "$row->description"?>" class="box" readonly>
         <span>Date de publication :</span>
         <input type="text"  value="<?php echo "$row->date_publication"?>" class="box" readonly>
   ...
   <br>
   <a href="../forum/article.php?id=<?php echo "$row->id"?>" target="_blank" class="btn">Répondre</a>
   <a href="delete-forum.php?question_forum_id=<?php echo "$row->id"?>" class=" delete-btn">supprimer la question </a>
