...
include 'database_forum1.php';
   ...
   $select = mysqli_query($conn, "SELECT * FROM `messages` WHERE id = '$id'") or die('query failed');
...
<form action=""  method="post" enctype="multipart/form-data">
    <h2 style="text-align: center;">Message de <?php echo $fetch['name']; ?> </h2>
   <?php
   ...
   <div class="flex">
      <div class="inputBox" style="width:100%; ">
         <span>Nom :</span>
         <input type="text"  value="<?php echo $fetch['name']; ?>" class="box" readonly>
         <span>Email :</span>
         <input type="text"  value="<?php echo $fetch['email']; ?>" class="box" readonly>
         <span>Objet :</span>
         <input type="text"  value="<?php echo $fetch['objet']; ?>" class="box" readonly>
         <span>Contenu du message:</span><br>

         <div style="border: 2px dashed black; padding:5px;">
         <?php echo $fetch['contenu']; ?>
         </div>
   ...
   <br>
   <a href="mailto:<?php echo $fetch['email']; ?>?subject=Reponse de MitecSchool" class="btn">Répondre par mail</a>
   <a href="delete.php?message_id=<?php echo $fetch['id']; ?>" class=" delete-btn">supprimer le message </a>
   <a href="messages.php" class="btn">Tous les messages</a>
