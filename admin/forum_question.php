			...
			<div class="main-content">
					...
					<div class="row" >
                        <div style="width: 100%;">
                            <div class="card" style="min-height: 485px; ">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title" style="text-align: center;">Questions du Forum</h4>
                                    <p class="category" style="text-align: center;">Listes des Questions posés dans le Forum</p>
                                </div>
                             ...
                             <?php
                                ...
                                $sth = $conn->prepare("SELECT * FROM `questions`");
                        ...
                        <tr>
                            ...
                            <td class="btn-info" style="text-align: center;"><a href="details-forum-question.php?question_forum_id=<?php echo "$row->id"?>" style="color: white;"><span class="material-icons">visibility</span></a></td>
                        </tr>
