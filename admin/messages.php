		...
		<div class="top-navbar">
			...
			<div class="main-content">
					...
					<div class="row" >
                        <div style="width: 100%;">
                            <div class="card" style="min-height: 485px; ">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title" style="text-align: center;">Messages</h4>
                                    <p class="category" style="text-align: center;">Listes des messages recus</p>
                                </div>
                        ...
                        <?php
                            ...
                            include 'database2.php';
                             ...
                             $sth = $conn->prepare("SELECT * FROM `messages` ORDER BY id desc");
                             ...
                             while($row = $sth->fetch())
                            {
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td class="btn-info" style="text-align: center;"><a href="details-message.php?message_id=<?php echo "$row->id"?>" style="color: white;"><span class="material-icons">visibility</span></a></td>
                                </tr>
                ...
                <?php } ?>
                                    ...
                                    <?php if($cpt==0) {?>
                                        <p style="text-align: center; color:red;">Aucun message pour le moment <br></p>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
